...
# Tarifas fijas por servicio y por cuidado especial (en pesos)
...
def filtrar_cuidados_especiales(lista_citas, indice=0):
    """Devuelve, de forma recursiva, solo las citas con manejo especial / sedacion."""
    if indice >= len(lista_citas):
        return []
...
def insertar_filas(lista_citas, indice=0):
    """Inserta recursivamente cada cita como una linea en la lista grafica."""
    if indice >= len(lista_citas):
        return
...
# ===========================================================================
# CONSTRUCCION DE LA VENTANA (imperativo: sin clases, sin estilos de color)
# ===========================================================================
...
tk.Label(marco_especie, text="Especie:").pack(side="left")
