...
# Agregamos un Label independiente para el título "Datos" (opcional)
tk.Label(ventana, text="Datos", bg="darkblue", fg="white", font=("Arial", 11, "bold")).pack(anchor="w", padx=25)

# Cambiamos LabelFrame por Frame y quitamos el parámetro 'text'
...
# Marco auxiliar para el Listbox + su barra de desplazamiento
